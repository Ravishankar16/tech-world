...
export default function QuestionListCopy2(){
    ...
    const [filteredQuestions, setFilteredQuestions] = useState(listOfQuestions.questions);
    
    
    const handleFilter = (category) => {
        const allQuestions = listOfQuestions.questions;
    ...
    const questionsToDisplay = selectedCategory || searchText ? filteredQuestions : listOfQuestions.questions;
      ...
      const handleSubmitQuestion = (newQuestion) => {
        ...
        // Update the filtered questions with the new question included
        setFilteredQuestions([updatedQuestion, ...filteredQuestions]);
      };
