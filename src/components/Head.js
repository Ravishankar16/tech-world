    ...
    <div className='grid grid-flow-col p-5 m-2 shadow-lg'>
        ...
        <div className='flex'>
          <ul className='flex space-x-4  px-4'>
            <li className="bg-blue-400 text-white text-md hover:bg-blue-700 hover:text-white p-2 rounded-md font-bold">DEV COMMUNITY</li>
            <li className="bg-blue-400 text-white text-md hover:bg-blue-700 hover:text-white p-2 rounded-md font-bold">ABOUT</li>
            <li className="bg-blue-400 text-white text-md hover:bg-blue-700 hover:text-white p-2 rounded-md font-bold">FORUM</li>
            <li className="bg-blue-400 text-white text-md hover:bg-blue-700 hover:text-white p-2 rounded-md font-bold">DISCUSSION</li>
            <li className="bg-blue-400 text-white text-md hover:bg-blue-700 hover:text-white p-2 rounded-md font-bold">TECH TALK</li>
          </ul>
        </div>
        ...
        {/* <QuestionList searchText={searchText}/> */}
    </div>
